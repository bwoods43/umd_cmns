...
This module assumes that field_orcid exists on the Team content type. If your site doesn't include that already, make sure to create by using the Repo field as an example.
